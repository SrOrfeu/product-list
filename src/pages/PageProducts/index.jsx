...
const PageProducts = () => {
    ...
    useEffect(() => {
        switch (ordenacao) {
            case 1:
                return setItensFiltrados([...itensFiltrados.sort((a, b) => b.review_rate - a.review_rate)]);
            case 2:
                return setItensFiltrados([...itensFiltrados.sort((a, b) => a.product_price - b.product_price)]);
            case 3:
                return setItensFiltrados([...itensFiltrados.sort((a, b) => b.product_price - a.product_price)]);
        }
